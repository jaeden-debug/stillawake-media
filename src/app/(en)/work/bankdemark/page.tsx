...
export const metadata: Metadata = {
  ...
  description:
    "How StillAwake Media built a calculator-led finance platform: 91-URL SEO architecture, 13 interactive calculators, #1 Google positions, and a measured 100/100/100 Lighthouse score.",
  alternates: {
...
const METRICS: [string, string, string][] = [
  ...
  ["91 URLs", "Calculator-led architecture", "13 interactive financial calculators, ~58 articles, and 9 pillar pages engineered as one internal-linking system — tools earn the rankings, content converts the intent."],
  ...
  return (
    <main className="bg-black pt-28 text-white">
      <ServiceJsonLd
        ...
        description="Calculator-led finance platform: 91-URL SEO architecture, 13 calculators, #1 Google positions, measured 100/100/100 Lighthouse."
        breadcrumb={[
          ["Home", "/"],
          ["Case Studies", "/work"],
      ...
      <section className="border-b border-white/10 px-6 pb-20 pt-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-8 max-w-3xl text-lg leading-8 text-white/70">
            ...
            articles alone can&apos;t. We architected 91 URLs around 13 calculators and the content that feeds them —
