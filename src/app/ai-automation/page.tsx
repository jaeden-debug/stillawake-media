...
export const metadata: Metadata = {
  title: "AI Automation",
  description: "StillAwake Media designs AI-powered systems for content, research, lead handling, admin workflows, reporting, customer support, and business operations.",
};

export default function Page() {
  const points = ['AI assistants', 'Admin workflows', 'Lead handling', 'Content systems', 'Research automation', 'Reporting workflows'];
      ...
      <section className="relative overflow-hidden px-6 py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="geist max-w-5xl text-5xl font-black leading-[.9] tracking-[-0.075em] md:text-8xl">
            AI workflows that remove repetitive business friction.
          </h1>

          <p className="mt-8 max-w-3xl text-lg leading-8 text-[#C7B9B9]">
            StillAwake Media designs AI-powered systems for content, research, lead handling, admin workflows, reporting, customer support, and business operations.
          </p>
