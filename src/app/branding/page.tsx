...
export const metadata: Metadata = {
  title: "Branding",
  description: "StillAwake Media creates visual identity systems, messaging direction, typography, colors, logo direction, digital assets, and brand experiences that build trust before a visitor reads a word.",
};

export default function Page() {
  const points = ['Brand identity', 'Logo direction', 'Typography systems', 'Color systems', 'Messaging strategy', 'Premium digital presence'];
      ...
      <section className="relative overflow-hidden px-6 py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="geist max-w-5xl text-5xl font-black leading-[.9] tracking-[-0.075em] md:text-8xl">
            Brand systems that make businesses feel premium instantly.
          </h1>

          <p className="mt-8 max-w-3xl text-lg leading-8 text-[#C7B9B9]">
            StillAwake Media creates visual identity systems, messaging direction, typography, colors, logo direction, digital assets, and brand experiences that build trust before a visitor reads a word.
          </p>
