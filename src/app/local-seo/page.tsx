...
export const metadata: Metadata = {
  title: "Local SEO",
  description: "We structure websites, content, service pages, Google Business Profile strategy, and local search signals to help businesses show up where customers are already searching.",
};

export default function Page() {
  const points = ['Google Business Profile strategy', 'Local landing pages', 'Service-area SEO', 'Internal linking', 'Technical SEO cleanup', 'Conversion-focused local pages'];
      ...
      <section className="relative overflow-hidden px-6 py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="geist max-w-5xl text-5xl font-black leading-[.9] tracking-[-0.075em] md:text-8xl">
            Local SEO systems built to make businesses easier to find.
          </h1>

          <p className="mt-8 max-w-3xl text-lg leading-8 text-[#C7B9B9]">
            We structure websites, content, service pages, Google Business Profile strategy, and local search signals to help businesses show up where customers are already searching.
          </p>
