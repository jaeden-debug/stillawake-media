...
export default function Home(){return <main><section className="relative min-h-screen overflow-hidden px-6"><video className="heroVideo absolute inset-0 h-screen min-h-screen w-full object-cover opacity-65" src="/stillawakemedia-hero.mp4" autoPlay muted loop playsInline/><div className="absolute inset-0 bg-gradient-to-b from-black/40 via-[#050505]/50 to-[#050505]"/><div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_35%,rgba(215,25,32,.25),transparent_35%)]"/><div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-start pt-32"><div className="flex w-full items-center">
...
<section className="px-6 py-10 md:py-16">
  <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] border border-white/10 bg-black shadow-2xl">
    ...
    <video
      ...
      src="/tv-static-stillawake-media-intro.mp4"
      autoPlay
      muted
      loop
      playsInline
