...
export const metadata: Metadata = {
  ...
  description: "We build practical software systems around real business workflows: internal tools, client portals, dashboards, web applications, automations, and scalable digital infrastructure.",
};

export default function Page() {
  const points = ['Custom web apps', 'Dashboards and portals', 'Workflow tools', 'Next.js systems', 'Business automation', 'Scalable infrastructure'];
      ...
      <section className="relative overflow-hidden px-6 py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="geist max-w-5xl text-5xl font-black leading-[.9] tracking-[-0.075em] md:text-8xl">
            Custom software, dashboards, portals, and digital systems.
          </h1>

          <p className="mt-8 max-w-3xl text-lg leading-8 text-[#C7B9B9]">
            We build practical software systems around real business workflows: internal tools, client portals, dashboards, web applications, automations, and scalable digital infrastructure.
          </p>
