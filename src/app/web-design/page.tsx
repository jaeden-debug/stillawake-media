...
export const metadata: Metadata = {
  title: "Web Design",
  description: "StillAwake Media builds high-performance websites with cinematic design, clean structure, SEO-ready architecture, mobile-first UX, and conversion-focused page systems.",
};

export default function Page() {
  const points = ['Custom-coded websites', 'Conversion architecture', 'Technical SEO structure', 'Mobile-first UX', 'Fast loading performance', 'Premium visual direction'];
      ...
      <section className="relative overflow-hidden px-6 py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="geist max-w-5xl text-5xl font-black leading-[.9] tracking-[-0.075em] md:text-8xl">
            Premium websites built to rank, convert, and scale.
          </h1>

          <p className="mt-8 max-w-3xl text-lg leading-8 text-[#C7B9B9]">
            StillAwake Media builds high-performance websites with cinematic design, clean structure, SEO-ready architecture, mobile-first UX, and conversion-focused page systems.
          </p>
