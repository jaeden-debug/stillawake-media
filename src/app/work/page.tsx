...
export default function Page() {
  const points = ['Live projects', 'Website systems', 'Brand assets', 'Software concepts', 'SEO architecture', 'Conversion systems'];
      ...
      <section className="relative overflow-hidden px-6 py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <h1 className="geist max-w-5xl text-5xl font-black leading-[.9] tracking-[-0.075em] md:text-8xl">
            Live websites, digital systems, and brand experiences.
          </h1>

          <p className="mt-8 max-w-3xl text-lg leading-8 text-[#C7B9B9]">
            Explore StillAwake Media projects across websites, SEO systems, software concepts, brand assets, and digital infrastructure.
          </p>
