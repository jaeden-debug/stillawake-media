...
export const SERVICES: ServiceEntry[] = [
  ...
  },
  {
    ...
    nameFr: "Refonte de site web",
    category: "design",
    enPath: "/website-redesign",
    frPath: "/fr/refonte-site-web",
    billing: "custom",
    price: null,
    primaryKeywordEn: "website redesign",
    primaryKeywordFr: "refonte site web",
    localIntent: true,
    remoteIntent: true,
    related: ["web-design", "seo-essentials", "website-maintenance"],
    active: true,
  },
  {
    ...
    frPath: "/fr/developpement-logiciel",
    billing: "custom",
    price: null,
    primaryKeywordEn: "custom web development",
    primaryKeywordFr: "développement logiciel sur mesure",
    localIntent: false,
    remoteIntent: true,
  ...
  },
  {
    ...
    category: "design",
    enPath: "/branding",
    frPath: "/fr/image-de-marque",
    billing: "custom",
    price: null,
    primaryKeywordEn: "branding services",
    primaryKeywordFr: "image de marque",
    localIntent: false,
    remoteIntent: true,
    related: ["web-design"],
    active: true,
  },
  {
    ...
    frPath: "/fr/automatisation-ia",
    billing: "custom",
    price: null,
    primaryKeywordEn: "ai automation services",
    primaryKeywordFr: "automatisation ia",
    localIntent: false,
    remoteIntent: true,
  ...
  },
  {
    ...
    frPath: "/fr/developpement-framer",
    billing: "custom",
    price: null,
    primaryKeywordEn: "framer development services",
    primaryKeywordFr: "développement framer",
    localIntent: false,
    remoteIntent: true,
    related: ["web-design"],
    active: true,
